...
GameFrame.Input = new Class({
	...
	initialize: function( game, method, triggers )
	{
		...
		if ( this.method & GameFrame.Input.METHOD_KEYBOARD ) {
		...
		if ( this.method & GameFrame.Input.METHOD_MOUSE ) {
	...
	{
		this._triggerEvent( GameFrame.Input.MouseInput.LEFT_CLICK, { 
			type: GameFrame.Input.METHOD_MOUSE,
			x: e.x, 
			y: e.y 
		});
	...
	_eventKeyDown: function( e )
	{
		...
		this._triggerEvent( e.keyCode, { 
			type: GameFrame.Input.METHOD_KEYBOARD, 
			//key: GameFrame.Input.KeyNames[e.keyCode], 
			active: true 
		});
...
GameFrame.Input.InputNames = [];
for ( _key in GameFrame.Input.KeyInput ) {
	GameFrame.Input.InputNames[ GameFrame.Input.KeyInput[_key] ] = _key;
}
for ( _key in GameFrame.Input.MouseInput ) {
	GameFrame.Input.InputNames[ GameFrame.Input.MouseInput[_key] ] = _key;
}
